...
BPF = butterworthBandpassFilter(fs, 6, 0.8, 1);
% freqz(BPF, numFrames);
% fvtool(BPF);
...
% alpha = [0 0 3 5 10]; % alpha for face1
alpha = [0 0 5 10 30]; % alpha for face2
...
% Export the video
myVideo = VideoWriter('face_6081_0051030.AVI', 'uncompressed AVI');
